...
object RunRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val base = "/home/veronica/Escritorio/profiledata_06-May-2005/"
    ...
    val mensaje = "Termina preparation"
    mensaje.foreach(print _)
    runRecommender.model(rawUserArtistData, rawArtistData, rawArtistAlias)
    val mensaje1 = "Termina model"
    mensaje1.foreach(print _)
    runRecommender.evaluate(rawUserArtistData, rawArtistAlias)
    val mensaje2 = "Termina evaluate"
    mensaje2.foreach(print _)
    runRecommender.recommend(rawUserArtistData, rawArtistData, rawArtistAlias, args(0))
    val mensaje3 ="Termina recommend"
    mensaje3.foreach(print _)
  }
...
class RunRecommender(private val spark: SparkSession) {
  ...
  def recommend(
                 rawUserArtistData: Dataset[String],
                 rawArtistData: Dataset[String],
                 rawArtistAlias: Dataset[String], usuario: String): Unit = {
